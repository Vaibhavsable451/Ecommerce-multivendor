...
const HomePage = () => {
  // Debug: log seller.report
  const { seller } = useAppSelector((store) => store);
  console.log('Seller report:', seller.report);
      ...
      <section className="grid grid-cols-4 gap-5">
        <div className="col-span-4 md:col-span-2 lg:col-span-1">
          <ReportCard
            ...
            value={"$" + ((seller.report?.totalEarnings ?? 0).toLocaleString())}
        ...
        <div className="col-span-4 md:col-span-2 lg:col-span-1">
          <ReportCard
            icon={<AccountBalanceIcon />}
            value={seller.report?.totalSales ?? 0}
            title={"Total Sales"}
          />
        </div>
        <div className="col-span-4 md:col-span-2 lg:col-span-1">
          <ReportCard
            icon={<AccountBalanceIcon />}
            value={seller.report?.totalRefunds ?? 0}
            title={"Total Refund"}
          />
        </div>
        ...
        <div className="col-span-4 md:col-span-2 lg:col-span-1">
          <ReportCard
            icon={<AccountBalanceIcon />}
            value={seller.report?.canceledOrders ?? 0}
            title={"Cancel Orders"}
          />
        </div>
      </section>
